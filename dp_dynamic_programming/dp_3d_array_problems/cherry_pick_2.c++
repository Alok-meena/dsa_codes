                ...
                for(int j2=0;j2<m;j2++){
                    ...
                    for(int d1=-1;d1<=1;d1++){
                        for(int d2=-1;d2<=1;d2++){
                            ...
                            if(j1==j2){
                                if(i+1<n and j1+d1>=0 and j1+d1<m and j2+d2>=0 and j2+d2<m) cherry=max(cherry,val1+dp[i+1][j1+d1][j2+d2]);
                            }
                            else if(i+1<n and j1+d1>=0 and j1+d1<m and j2+d2>=0 and j2+d2<m) cherry=max(cherry,val1+val2+dp[i+1][j1+d1][j2+d2]);
                        }
                    }
